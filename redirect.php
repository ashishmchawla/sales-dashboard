...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.2.0/css/all.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous" defer>
    </head>
    <style type="text/css">
        .redirect-div {
            margin-top: 10%;
    ...
    <div class="row">
            ...
            <div class="redirect-div col-md-8">
                    <h3 style="font-family: 'Open Sans', sans-serif;"> <span style="font-size: 36px;">🚀</span> <br/>
                        ...
                        <div class='loader' style='align-content: center;vertical-align: middle; margin-top: 2%; z-index: 20;display: block;'>
                            <style type='text/css'>
                                .fa-spin-custom,
                                .glyphicon-spin {
                                ...
                                <div style='padding:4px;border-radius: 2px;'><i class='fa fa-spinner fa-spin-custom' style='font-size: 16px'></i></div>
                        </div>
                    </h3>
